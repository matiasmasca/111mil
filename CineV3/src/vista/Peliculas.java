...
public class Peliculas extends javax.swing.JFrame {
   ...
   private void runQuery3() {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Seleccione los Siguientes Datos"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Ingrese los Datos Restantes"));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Disponible"));
    ...
    private void executeHQLQuery3(String hql3) {
        try {
        Session session = HibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
